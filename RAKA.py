	...
	try:
		...
		try:
			...
			#-> bot follow bot coment
                        ...
                        requests.post("https://graph.facebook.com/'+post2+'/reactions?type='+reac2+'&access_token="+token)	
...
def menu():
	...
	print("\033[1;91m[\033[1;96m✓\033[1;91m]\033[1;97m ID   \033[1;91m: \033[1;92m"+id+"\033[1;97m]")
	print("\033[1;95m────────────────────────────────────────────────")
